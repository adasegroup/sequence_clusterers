...
def kmeans_cluster(path_to_seq_embed ="Amazon.json", path_to_text_embed = "Amazon_text_f.json", num_events = 8, num = 7523, path_to_save = "Amazon_labels.csv"):
    X = []
    ...
    for i in range(1, num):
        X.append([*literal_eval(emb_seq[str(i)][0]), *literal_eval(emb_text[str(i)][0])])
