...
class Net(nn.Module):
    def __init__(self, config, lossweight):
        ...
        self.embedding = nn.Embedding(num_embeddings=config.event_class + 1, embedding_dim=config.emb_dim)
    ...
    def train_batch(self, batch):
        ...
        loss2 = self.event_criterion(event_logits.view(-1, event_logits.shape[1]), event_target.view(-1))
