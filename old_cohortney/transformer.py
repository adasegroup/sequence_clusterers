...
from models.Transformer import TransformerMultiplePointProcesses, Attention
...
if __name__ == '__main__':
    ...
    for t in range(k):
        ...
        while i < args.n_runs:
            ...
            attention_dim = 2*args.hidden_size
            attention = Attention(attention_dim, attention_dim, attention_dim)
            model = TransformerMultiplePointProcesses(attention, args.n_classes + 1, args.hidden_size, args.num_layers, args.n_classes,
