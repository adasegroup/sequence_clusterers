...
from models.GRU import GRUMultiplePointProcesses
...
def parse_arguments():
    ...
    parser.add_argument('--num_layers', type=int, default=3, help='number of GRU layers, default - 3')
    parser.add_argument('--dropout', type=float, default=0.3, help='GRU dropout rate, default - 0.3')
    parser.add_argument('--lr', type=float, default=0.15, help='optimizer initial learning rate, default - 0.1')
    parser.add_argument('--weight_decay', type=float, default=1e-5, help='optimizer weight decay, default - 1e-5')
    parser.add_argument('--n_runs', type=int, default=2, help='number of starts, default - 5')
    ...
    parser.add_argument('--max_epoch', type=int, default=30, help='number of epochs of EM algorithm, default - 50')
    parser.add_argument('--max_m_step_epoch', type=float, default=6, help='int(max_m_step_epoch) - number of epochs'
    ...
    parser.add_argument('--device', type=str, default='cuda:0', help='device that should be used for training, default - '
                                                                  'cpu')
...
if __name__ == '__main__':
    ...
    create_folder('experiments/GRU/')
    create_folder('experiments/GRU/' + args.save_dir)
    path_to_results = 'experiments/GRU/' + args.save_dir
    ...
    while i < args.n_runs:
        ...
        model = GRUMultiplePointProcesses(args.n_classes + 1, args.hidden_size, args.num_layers, args.n_classes,
