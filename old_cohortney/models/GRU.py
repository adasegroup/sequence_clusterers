...
class GRUSinglePointProcess(nn.Module):
    """
            ...
            for b in range(batch_size):
                ...
                for s in range(seq_len):
                    ...
                    if s == 0:
                        ...
                        # computing lambda
                        o, (hidden) = self.gru(res[b, s - 1][None, None, :], (hidden))
...
class GRUMultiplePointProcesses(nn.Module):
    """
